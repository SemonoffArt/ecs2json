...
**ecs2json** — утилита командной строки для извлечения тегов (тегов точек контроля) из баз данных **ECS** (система автоматизации) и экспорта их в различные форматы.
